...
router.post('/', check_authentication, check_authorization(constants.MOD_PERMISSION), CreateUserValidator, validate, async function (req, res, next) {
  try {
    let body = req.body;
...
router.put('/:id', check_authentication, check_authorization(constants.MOD_PERMISSION), UpdateUserValidator, validate, async function (req, res, next) {
  try {
    let body = req.body;
